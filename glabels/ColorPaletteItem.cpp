...
namespace glabels
{
	...
	///
        ColorPaletteItem::ColorPaletteItem( int id, const QColor& color, const QString& tip, QWidget* parent )
	...
	///
        void ColorPaletteItem::setColor( int id, const QColor& color, const QString& tip )
	{
		mId    = id;
		mColor = color;
		mTip   = tip;
